...
import { getUserRequest, userLogout } from "../../../utils/burger-api";
import { deleteUserData, setUserData } from "../../../services/actions/user";
import {
    TEXT_DEFAULT,
    TEXT_INACTIVE_COLOR,
    TEXT_MEDIUM,
...
import OrdersPage from "../orders-page/oreders-page";
...
const Profile = () => {
    ...
    const { userEmail, userName } = useSelector((store) => ({
